...
*/
var paytmChecksum = PaytmChecksum.generateSignature(paytmParams, "NJGKEi15196560300156");
paytmChecksum.then(function(result){
	console.log("generateSignature Returns: " + result);
	var verifyChecksum =  PaytmChecksum.verifySignature(paytmParams, "1001",result);
